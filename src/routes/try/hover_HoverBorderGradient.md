# hover/HoverBorderGradient.svelte

A button or container with an animated, glowing border gradient on hover.
...
- Use as a button or container with a glowing animated border on hover.
- Customizable via props: `containerClassName`, `className`, `duration`, `clockwise`, `as` (element type).

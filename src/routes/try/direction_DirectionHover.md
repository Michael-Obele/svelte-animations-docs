# direction/DirectionHover.svelte

A card that animates based on the direction of mouse entry, using Svelte Motion.
...
- Animates card entry based on mouse direction (top, right, bottom, left).
- Uses Svelte Motion for smooth transitions.

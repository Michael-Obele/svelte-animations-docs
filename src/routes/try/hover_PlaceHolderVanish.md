# hover/PlaceHolderVanish.svelte

An animated input with vanishing placeholder text and a canvas-based vanish effect on submit.
...
- Animated placeholder cycles through multiple texts.
- On submit, input text vanishes with a canvas animation.
- Handles visibility changes and prevents animation when not visible.
